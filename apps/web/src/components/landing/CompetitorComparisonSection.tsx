...
const COMPARISON_DATA: ComparisonFeature[] = [
  ...
  {
    feature: 'Multi-Timeframe Confluence Replay',
    category: 'Tools',
    trademind: 'Dual-chart split view (1H macro bias + 5m execution) with bar sync',
    tradezella: 'Single timeframe replay',
    tradervue: 'Static charts only',
    ultratrader: 'No replay player',
    importance: 'Verify higher-timeframe trend alignment and order blocks while stepping through lower-timeframe entry ticks',
  },
  {
    feature: 'Prop Firm Multi-Account Scaling Matrix',
    category: 'Tools',
    trademind: 'Unified allocation, consolidated daily buffer & breach stress simulator',
    tradezella: 'Single account view only',
    tradervue: 'Manual tagging only',
    ultratrader: 'Basic prop tags',
    importance: 'Simultaneously monitor trailing high-water mark drawdowns across FTMO, Apex & Topstep accounts',
  },
  {
    feature: 'Automated EOD AI Voice Briefing',
    category: 'AI Intelligence',
    trademind: 'Native 60s synthesized audio debrief with waveform and speed controls',
    tradezella: 'Text debrief only',
    tradervue: false,
    ultratrader: false,
    importance: 'Hear institutional breakdown of your trading discipline immediately upon market close without reading',
  },
  {
    feature: 'Automated Weekly Edge Report (PDF Export)',
    category: 'Analytics',
    trademind: '1-Click institutional weekly audit, win rate by day of week & slippage saved',
    tradezella: 'Standard weekly table',
    tradervue: 'CSV raw export',
    ultratrader: 'Basic screenshot',
    importance: 'Institutional printable audit detailing performance by day of week, best playbook, and behavioral grade',
  },
  {
  ...
  {
    feature: 'Blind Forward-Testing & Strategy Simulator Studio',
    category: 'Tools',
    trademind: 'Bar-by-bar stepper, bracket orders, equity curve & Sharpe/Sortino KPI engine',
    tradezella: 'Replay only (no order simulator)',
    tradervue: false,
    ultratrader: false,
    importance: 'Validate edge forward in time without lookahead bias or risking capital',
  },
  {
    feature: 'Gemini Multimodal Chart Vision OCR',
    category: 'AI Intelligence',
    trademind: 'Multimodal OCR scans SMC liquidity sweeps, BOS, CHoCH & entry brackets directly from screenshots',
    tradezella: 'Manual drawing review only',
    tradervue: false,
    ultratrader: false,
    importance: 'Instantly decode chart screenshots and flag execution mistakes with AI',
  },
  {
    feature: 'Finnhub WebSocket Macro Wire & Prop Blackout Shield',
    category: 'Risk',
    trademind: 'Sub-millisecond trade ticks, breaking news wire & automatic countdown blackout lockouts for CPI/FOMC/NFP',
    tradezella: false,
    tradervue: false,
    ultratrader: false,
    importance: 'Prevents catastrophic prop firm account breach during high-volatility economic announcements',
  },
  {
    feature: 'Statutory Tax & Regulatory Ledger Engine',
    category: 'Analytics',
    trademind: 'ICAI F&O Turnover, Sec 44AD/44AB Audit Threshold & US IRS Form 8949 / Sec 1256 60/40',
    tradezella: false,
    tradervue: 'Basic US P&L only',
    ultratrader: false,
    importance: 'Ready for Chartered Accountants (CA) and CPAs with 1-click RFC-4180 CSV export',
  },
  {
