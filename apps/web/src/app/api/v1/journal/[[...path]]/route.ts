...
async function handleExportCsv(req: NextRequest, userId: string) {
  ...
  const rows = trades.map((t) => [
    ...
    t.avgEntryPrice.toFixed(2), t.avgExitPrice ? t.avgExitPrice.toFixed(2) : '',
    t.grossPnl.toFixed(2), t.totalFeesAndTaxes.toFixed(2), t.netPnl.toFixed(2),
    t.currency ?? 'INR', t.rMultiple ? t.rMultiple.toFixed(2) : '',
