...
const createFeatureFlagSchema = z.object({ name: z.string().min(2).max(100), description: z.string().optional(), isEnabled: z.boolean().default(false), rules: z.record(z.string(), z.any()).optional() });
